...
public class SecurityUsers {
	...
	public SecurityUsers(long user_id) {
		super();
	...
	public Date getResume_created_date() {
		return resume_created_date;
	}
	public void setResume_created_date(Date resume_created_date) {
		this.resume_created_date = resume_created_date;
	}
	public Date getResume_modified_date() {
		return resume_modified_date;
	}
	public void setResume_modified_date(Date resume_modified_date) {
		this.resume_modified_date = resume_modified_date;
	}
	@Override
	public int hashCode() {
		final int prime = 31;
